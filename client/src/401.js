...
function Unauthorized(){
    ...
    return(
        <div className="text-center" style={{"margin-top":"100px"}}>
            ...
            <p>You have attempted to access a page which you are not authorized. Please go back to <Link to={'/login'}><span className="h4">LOGIN PAGE</span></Link> and login again</p>
        </div>
    )
}
